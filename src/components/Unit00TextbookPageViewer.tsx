...
export default function Unit00TextbookPageViewer({
  ...
  const readPagesCount = readPagesList.length;
  const readPagesTotal = UNIT00_TEXTBOOK_PAGES.length;
      ...
      case 5: // Page 005
        return (
          <ThreePanelBentoLayout
            ...
            rightTitle="📍 幸福地標"
            rightIcon={<Map className="w-4 h-4 text-purple-600" />}
            rightContent={
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-xs font-black text-slate-800 block">
                    2. 請在下方選出你心目中最關鍵的三個幸福地標，並說明理由：
                  </label>
        ...
        return (
          <ThreePanelBentoLayout
            ...
            leftContent={
              <div className="space-y-4">
                <p className="text-xs font-semibold text-gray-600 leading-relaxed">
                  可華的爸爸認為：學生只需要認真讀書，是很幸福的！等你長大出社會工作，就知道什麼叫壓力。
                </p>
                <div className="bg-slate-50 border border-slate-200 p-3 rounded-xl space-y-2">
                  <span className="text-[10px] font-black text-slate-500 block uppercase">傳統方程式</span>
